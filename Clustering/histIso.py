...
class MakeHist():
    def __init__(self,_hName):
        ...
        self.isoowenplotallpu = TH1F ('isoowenplotallpu','isoRatio owen R01',100,0,10)
        self.detadphiallpu = TH2F ('detadphiallpu','deta vs. dphi',50,-.5,.5,50,-.5,.5)

        self.dReta15pu = TH2F ('dRgeta15pu','dRg',25,0.0,0.5,50,0,100)
        self.isoowenploteta15pu = TH1F ('isoowenploteta15pu','isoRatio owen R01',100,0,10)
        ...
        self.isoowenploteta20pu = TH1F ('isoowenploteta20pu','isoRatio owen R01',100,0,10)
        ...
        self.isoowenploteta25pu = TH1F ('isoowenploteta25pu','isoRatio owen R01',100,0,10)
        ...
        self.isoowenploteta30pu = TH1F ('isoowenploteta30pu','isoRatio owen R01',100,0,10)
